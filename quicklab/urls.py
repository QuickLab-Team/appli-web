"""
URL configuration for quicklab project.
...
urlpatterns = [
    ...
    path('password_reset_done/', auth_views.PasswordResetDoneView.as_view(template_name='utilisateurs/password_reset_done.html'), name='password_reset_done'),
